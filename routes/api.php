...
use App\Http\Controllers\Api\TestSalesmenController;
...
Route::group([
    ...
    Route::get('/call-plans/{id}', [MasterCallPlanController::class, 'getOne']);
    ...
    Route::get('/getCboSalesmanCallplan', [MasterCallPlanController::class, 'getCboSalesmanCallplan']);
    Route::get('/getCboCabangCallplan', [MasterCallPlanController::class, 'getCboCabangCallplan']);
    Route::get('/getCboTokoCallplan', [MasterCallPlanController::class, 'getCboTokoCallplan']);
...
Route::group([
    ...
    Route::group([
        ...
        // test salesman
        Route::get('/test_salesmen', [TestSalesmenController::class, 'getAll']);
